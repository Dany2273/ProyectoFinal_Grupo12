...
//        Cliente cli7 = new Cliente(TipoCliente.PERSONA_JURIDICA, "Local", 30937439004L, "Local", "Santa Fe 2090", "San Fernando", "1580", "1177226299", "local@gmail.com", true);
    ...
    // Propietario pro = new Propietario(7,TipoCliente.PERSONA_FISICA, "ramonalinda   ", 31121, 212332, "lugabajo", "domicilio", "ciudad22", "codigoPostal", "telefono", "mail", false);
//        pData.agregarPropietarioPF(pro);
  //pData.agregarPropietarioPF(pro);
  //pData.modificarPropietarioPF(pro);
 // pData.eliminarPropietario(7);
//        pData.listarProTodosInactivos();
//        System.out.println(pro.getCiudad());
//pData.buscarProPorCuilC(12);
//pData.listarProFisicosA();
